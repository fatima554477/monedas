...
<div class="top-bar">
    <div align='right'>
        <!-- Puedes agregar botones o filtros aquí -->
    </div>
</div>

<input type="text" id="buscadorMonedas" placeholder="Buscar en tabla..." class="form-control" style="margin-bottom: 10px; width: 300px;">

<div class="table-container">
<table class="table table-striped table-bordered" style="width:100%" id='reset_MONEDAS' name='reset_MONEDAS'>
<thead>
<tr style='background:#f5f9fc;text-align:center'>
    <th style="background:#c9e8e8">ENVIAR POR EMAIL</th>  
...
?>
<tr>
    <td><input type="checkbox" class="form-check-input" name="fotosve[]" id="fotosve" value="<?php echo $row["id"]; ?>"/></td>
